        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-300">Enterprise operations center for SafetySync.AI</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-white/10 backdrop-blur-sm border-white/20">
            <CardContent className="p-6">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-300">Uptime: {systemMetrics.uptime}%</p>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20">
            <CardContent className="p-6">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-300">Email service degraded</p>
            ...
            <CardContent className="p-6">
              ...
              <div className="mt-4">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-xs text-gray-300">Target: &lt;200ms</span>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm text-gray-300">Response Time Warning</label>
                      <input 
                        type="number" 
                        defaultValue="200"
                    ...
                    <div>
                      <label className="text-sm text-gray-300">Error Rate Alert</label>
                      <input 
                        type="number" 
                        defaultValue="0.1"
                        step="0.01"
