        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <button 
                ...
                className="text-blue-600 hover:text-blue-800 hover:bg-blue-100/50 px-3 py-2 text-sm font-medium transition-colors rounded-md"
              >
                Features
              </button>
              <a 
              ...
              <Link href="/contact">
                <button className="text-blue-600 hover:text-blue-800 hover:bg-blue-100/50 px-3 py-2 text-sm font-medium transition-colors rounded-md">
                  Contact
                </button>
              </Link>
            </div>
          ...
          <div className="md:hidden">
            <Button
              ...
              className="text-blue-800 hover:text-blue-800 hover:bg-blue-200 bg-blue-100 border border-blue-300 shadow-sm"
            >
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-blue-200">
              ...
              <div className="border-t border-blue-200 pt-3 mt-3 space-y-2">
                <Link href="/client-portal">
                  <Button 
                    variant="ghost" 
                    className="w-full justify-center text-blue-600 hover:text-blue-800 hover:bg-blue-100/50 px-3 py-2 text-sm font-medium transition-colors rounded-md"
                  >
                    Client Login
                  </Button>
                </Link>
