                  ...
                  <Card className="bg-blue-700/50 backdrop-blur-sm border-blue-400/30 text-white p-6">
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-6">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-white">Compliance</div>
                      </div>
                      <div className="text-center">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-white">Alerts</div>
                      </div>
                    </div>
                  ...
                  <Card className="bg-blue-700/50 backdrop-blur-sm border-blue-400/30 text-white p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-white">Fall protection training due in 2 weeks</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                        <span className="text-white">Compliance rate improved by 15%</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                        <span className="text-white">Equipment inspection scheduled</span>
                      </div>
                    </div>
                  </Card>
                </>
              ...
              <Card className="bg-blue-700/50 backdrop-blur-sm border-blue-400/30 text-white">
                ...
                <CardContent>
                  <div className="h-64 bg-blue-600/50 rounded-lg flex items-center justify-center">
                    <span className="text-white">Interactive Chart Placeholder</span>
                  </div>
