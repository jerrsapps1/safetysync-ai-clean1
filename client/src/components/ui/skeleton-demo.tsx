                  ...
                  <Card className="bg-blue-700/50 backdrop-blur-sm border-white/10 text-white p-6">
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-6">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-blue-300">Compliance</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-400">247</div>
                        <div className="text-sm text-blue-300">Employees</div>
                      </div>
                      <div className="text-center">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-blue-300">Alerts</div>
                      </div>
                    </div>
                    <div className="h-32 bg-blue-600/50 rounded-lg flex items-center justify-center">
                      <span className="text-blue-300">Chart Area</span>
                    </div>
                  </Card>
                  <Card className="bg-blue-700/50 backdrop-blur-sm border-white/10 text-white p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-blue-300">Fall protection training due in 2 weeks</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                        <span className="text-blue-300">Compliance rate improved by 15%</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                        <span className="text-blue-300">Equipment inspection scheduled</span>
                      </div>
                    </div>
                  </Card>
                </>
              ...
              <Card className="bg-blue-700/50 backdrop-blur-sm border-white/10 text-white max-w-2xl">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full p-3 bg-blue-600/50 border border-blue-500 rounded-lg text-white"
                  ...
                  <div>
                    ...
                    <select className="w-full p-3 bg-blue-600/50 border border-blue-500 rounded-lg text-white">
          ...
          <TabsContent value="charts" className="space-y-6">
            {showSkeletons ? (
              ...
              <Card className="bg-blue-700/50 backdrop-blur-sm border-white/10 text-white">
                ...
                <CardContent>
                  <div className="h-64 bg-blue-600/50 rounded-lg flex items-center justify-center">
                    <span className="text-blue-300">Interactive Chart Placeholder</span>
                  </div>
                  <div className="flex justify-center space-x-6 mt-4">
                    <div className="flex items-center space-x-2">
                      <div className="w-3 h-3 bg-blue-400 rounded-full"></div>
                      <span className="text-sm text-blue-300">Compliance Rate</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-3 h-3 bg-green-400 rounded-full"></div>
                      <span className="text-sm text-blue-300">Training Completion</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-3 h-3 bg-purple-400 rounded-full"></div>
                      <span className="text-sm text-blue-300">Certifications</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
