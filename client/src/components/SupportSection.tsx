  ...
  return (
    <section className="bg-white py-12 px-6 rounded-xl shadow max-w-5xl mx-auto mt-10">
      <div className="text-center">
        ...
        <h3 className="text-2xl font-bold text-blue-800 mb-2">Still have questions?</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-blue-50 rounded-lg p-6 text-center">
            ...
            <h4 className="font-semibold text-blue-800 mb-1">Live Chat</h4>
            <p className="text-blue-700 text-sm mb-4">Available 24/7</p>
          ...
          <div className="bg-green-50 rounded-lg p-6 text-center">
            ...
            <h4 className="font-semibold text-green-800 mb-1">Email Support</h4>
            <p className="text-green-700 text-sm mb-4">Response within 2 hours</p>
          ...
          <div className="bg-purple-50 rounded-lg p-6 text-center">
            ...
            <h4 className="font-semibold text-purple-800 mb-1">Premium Support</h4>
            <p className="text-purple-700 text-sm mb-4">For paying customers</p>
